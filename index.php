...
?>
    <div class="container position-relative">
        ...
        <div class="carousel-control-prev" href="#carouselExampleControls" style="z-index:3;">
            <a style="font-size: 5rem;opacity:0.5;margin-left:15px;" href='index.php?Y=<?=$preyear?>&m=<?=$premonth?>'>
                <i class="fas fa-water"></i>
            </a>
        </div>
        <div class="carousel-control-next" href="#carouselExampleControls" style="z-index:3;">
            <a style="font-size: 5rem;opacity:0.5;margin-left:15px;" href='index.php?Y=<?=$nextyear?>&m=<?=$nextmonth?>'>
                <i class="fas fa-water"></i>
            </a>
        ...
        <div class="container-fluid justify-content-center position-relative overflow-hidden"
            style="z-index:1; border-radi">
            <div class="container my-5 d-flex justify-content-center align-items-center position-relative"
                style="width:600px;height: 600px;box-shadow:1px 1px 10px #185761; border-radius:50%;z-index:1;">
                ...
                <div class="d-flex justify-content-center align-items-center bg-transparent">
                    ...
                    <?php
                      ...
                      echo "</table>";
                      ?>
                    <div id="carouselExampleControls" class="carousel slide carousel-fade position-absolute"
                        style="z-index:-10000;border-radius: 100%;" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="https://picsum.photos/700/700/?random=1"
                                    style="z-index:-10000;border-radius: 100%; opacity:0.3;" class="d-block w-100"
                                    alt="...">
                            </div>
